...
public class IBDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + IBPlannerContract.UserIBDataEntry.TABLE_NAME + " (" +
                IBPlannerContract.UserIBDataEntry.IB_SUBJECT_GROUP_COLUMN + " INTEGER NOT NULL PRIMARY KEY" +
                IBPlannerContract.UserIBDataEntry.IB_SUBJECT_NAME_COLUMN + " TEXT NOT NULL, " +
                IBPlannerContract.UserIBDataEntry.IB_SUBJECT_LEVEL_COLUMN + " TEXT NOT NULL");
